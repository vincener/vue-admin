<template>
  <div class="app-container">
    <div class="filter-container">
      <span class="demonstration">机构名称：</span> <el-input v-model="searchConfig.conditions.name" placeholder="机构名称" style="width: 200px;" class="filter-item" @keyup.enter.native="search"/>
...
<script>
import { getPage, save, deleteById, update, getById } from '@/api/role.js'
